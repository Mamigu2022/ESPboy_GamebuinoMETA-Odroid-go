...
public:
	...
	virtual void drawBitmap(int16_t x, int16_t y, const uint8_t *bitmap, int8_t scale);
	virtual void drawBitmap(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t rotation, uint8_t flip);
