...
Display_ST7735::Display_ST7735()  : Graphics(320,240 ) {
}
...
void Display_ST7735::setTextSize(uint8_t size){
...
void Display_ST7735::pushColors(uint16_t  *data, uint32_t len, bool swap){
