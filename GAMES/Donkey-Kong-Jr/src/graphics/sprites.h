...
constexpr PROGMEM uint8_t InfoGameA = 0;
constexpr PROGMEM uint8_t InfoGameB = 1;
constexpr PROGMEM uint8_t InfoMiss  = 2;

constexpr PROGMEM Sprite infoSprite[] = {
    {  92,  3, 23, 5, 0x0000 }, // InfoGameA
    {  92, 13, 23, 5, 0x0000 }, // InfoGameB
    { 108, 23, 15, 5, 0x0000 }  // InfoMiss
};

constexpr PROGMEM Sprite headSprite[] = {
    { 126, 20, 9, 11, 0x0000 },
    { 136, 20, 9, 11, 0x0000 },
    { 146, 20, 9, 11, 0x0000 }
};
...
constexpr PROGMEM Sprite marioSprite = { 5, 49, 13, 19, 0x1f00 };

constexpr PROGMEM Sprite keySprite[] = {
    { 51, 11,  6, 20, 0xe0fe },
    { 58,  9,  5, 22, 0xe0fe },
    { 62, 11,  8, 17, 0x60fe },
    { 65,  9, 13, 14, 0x40fc }
...
constexpr PROGMEM Sprite cageSprite[] = {
    { 18,  3, 12, 18, 0x1f00 },
    {  3,  3, 12, 18, 0x1f00 },
    {  3, 24, 12, 17, 0x0000 },
    { 18, 24, 19, 17, 0x1f00 }
...
constexpr PROGMEM Sprite smileSprite = { 12, 15, 9, 8, 0x0000 };

// -------------------------------------------------------------------------
// Fruit
// -------------------------------------------------------------------------

constexpr PROGMEM Sprite fruitSprite[] = {
    { 83,  29, 9, 11, 0xe007 },
    { 83,  45, 7, 19, 0xe007 },
    { 82,  78, 9, 16, 0xe007 },
    { 81, 101, 9, 12, 0xe007 }
...
constexpr PROGMEM int8_t Forbidden   = -1;
constexpr PROGMEM int8_t Bottom1     =  0;
constexpr PROGMEM int8_t Bottom2     =  1;
constexpr PROGMEM int8_t Bottom3     =  2;
constexpr PROGMEM int8_t Bottom4     =  3;
constexpr PROGMEM int8_t Bottom5     =  4;
constexpr PROGMEM int8_t Bottom6     =  5;
constexpr PROGMEM int8_t BottomJump1 =  6;
constexpr PROGMEM int8_t BottomJump2 =  7;
constexpr PROGMEM int8_t BottomJump3 =  8;
constexpr PROGMEM int8_t BottomJump4 =  9;
constexpr PROGMEM int8_t BottomJump5 = 10;
constexpr PROGMEM int8_t BottomJump6 = 11;
constexpr PROGMEM int8_t Top1        = 12;
constexpr PROGMEM int8_t Top2        = 13;
constexpr PROGMEM int8_t Top3        = 14;
constexpr PROGMEM int8_t Top4        = 15;
constexpr PROGMEM int8_t TopJump1    = 16;
constexpr PROGMEM int8_t TopJump2    = 17;
constexpr PROGMEM int8_t TopJump3    = 18;
constexpr PROGMEM int8_t GrabKey     = 19;
constexpr PROGMEM int8_t Unlock      = 20;
constexpr PROGMEM int8_t ArmUp       = 21;
constexpr PROGMEM int8_t ArmDown     = 22;
constexpr PROGMEM int8_t ComeDown    = 23;
constexpr PROGMEM int8_t Fall1       = 24;
constexpr PROGMEM int8_t Fall2       = 25;

constexpr PROGMEM Sprite juniorSprite[] = {
...
constexpr PROGMEM int8_t moveLeft[] = {
//  to:             from:
    Forbidden,   // Bottom1
    Bottom1,     // Bottom2
    Bottom2,     // Bottom3
...
constexpr PROGMEM int8_t moveRight[] = {
//  to:             from:
    Bottom2,     // Bottom1
    Bottom3,     // Bottom2
    Bottom4,     // Bottom3
...
constexpr PROGMEM int8_t moveUp[] = {
//  to:             from:
    BottomJump1, // Bottom1
    BottomJump2, // Bottom2
    BottomJump3, // Bottom3
...
constexpr PROGMEM int8_t moveDown[] = {
//  to:             from:
    Forbidden,   // Bottom1
    Forbidden,   // Bottom2
    Forbidden,   // Bottom3
...
constexpr PROGMEM Sprite crocSprite[] = {
    {  38,  66, 10, 10, 0x00f8 },
    {  57,  67,  8, 10, 0x00f8 },
    {  80,  66, 10,  9, 0x00f8 },
    { 103,  67,  9,  8, 0x00f8 },
...
constexpr PROGMEM Sprite birdSprite[] = {
    {   2, 74,  8, 12, 0x00f8 },
    {  13, 88, 11,  9, 0x00f8 },
    {  35, 88, 11,  9, 0x00f8 },
    {  58, 92, 11,  9, 0x00f8 },
...
constexpr PROGMEM int8_t bittenByCroc[] = {
...
constexpr PROGMEM int8_t bittenByBird[] = {
//  Junior index || crocSprite[i]
    Forbidden,   //     i = 0
    BottomJump1, //     i = 1
    BottomJump2, //     i = 2
...
constexpr PROGMEM int8_t bittenByCrocWhenMoveLeft[] = {
    -1, // Bottom1
    11, // Bottom2
    10, // Bottom3
     9, // Bottom4
...
constexpr PROGMEM int8_t bittenByCrocWhenMoveRight[] = {
    11, // Bottom1
    10, // Bottom2
     9, // Bottom3
     8, // Bottom4
...
constexpr PROGMEM int8_t bittenByBirdWhenMoveLeft[] = {
    -1, // Bottom1
    -1, // Bottom2
    -1, // Bottom3
    -1, // Bottom4
...
constexpr PROGMEM int8_t bittenByBirdWhenMoveRight[] = {
    -1, // Bottom1
    -1, // Bottom2
    -1, // Bottom3
    -1, // Bottom4
