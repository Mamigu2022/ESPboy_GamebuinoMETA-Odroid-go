...
const PROGMEM uint8_t floorTileBuff[] = {8, 8, 1, 0, 0, 0xFF, 1, 0xb3, 0x33,0x33, 0x3b,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0x33, 0x33,0xb3, 0x33,0x33, 0x3b};
Image floorTile = Image(floorTileBuff);
const PROGMEM uint8_t mineFloorData[] = {8, 8, 1, 0, 0, 0xFF, 1, 0x66, 0x66,0x66, 0x65,0x66, 0x66,0x66, 0x65,0x66, 0x66,0x66, 0x65,0x66, 0x66,0x66, 0x65,0x66, 0x66,0x66, 0x65,0x66, 0x66,0x66, 0x65,0x66, 0x66,0x66, 0x65,0x55, 0x55,0x55, 0x55};
Image mineFloor = Image(mineFloorData);
const PROGMEM uint8_t cryptFloorData[] = {8, 8, 1, 0, 0, 0xFF, 1, 0x66, 0x66,0x66, 0x66,0x66, 0x66,0x66, 0x66,0x66, 0x66,0xe6, 0x66,0x66, 0x6e,0xee, 0x66,0x66, 0xee,0xee, 0xe6,0x66, 0x6e,0xee, 0x66,0x66, 0x66,0xe6, 0x66,0x66, 0x66,0x66, 0x66};
Image cryptFloor = Image(cryptFloorData);
const PROGMEM uint8_t palaceFloorData[] = {8, 8, 1, 0, 0, 0xFF, 1, 0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55};
Image palaceFloor = Image(palaceFloorData);
const PROGMEM uint8_t wallTileBuff[] = {8, 8, 2, 0, 0, 0xFF, 1, 0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0xff, 0xff,0xff, 0xff,0xff, 0xff,0xff, 0xff,0xff, 0xff,0xff, 0xff,0xff, 0xff,0xff, 0xff,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55,0x55, 0x55};
Image wallTile = Image(wallTileBuff);
const PROGMEM uint8_t mineWallData[] = {8, 8, 2, 0, 0, 0xFF, 1, 0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0xff, 0xef,0xff, 0xfe,0xfe, 0xff,0xff, 0xf2,0xff, 0xff,0x2f, 0xff,0xff, 0xff,0xe2, 0xff,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44,0x44, 0x44};
Image mineWall = Image(mineWallData);
const PROGMEM uint8_t cryptWallData[] = {8, 8, 2, 0, 0, 0xFF, 1, 0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22};
Image cryptWall = Image(cryptWallData);
const PROGMEM uint8_t portalClosedData[] = {8, 8, 1, 0, 0, 0xFF, 1, 0x22, 0x22,0x22, 0x22,0x20, 0x00,0x00, 0x02,0x20, 0x00,0x00, 0x02,0x20, 0x00,0x00, 0x02,0x20, 0x00,0x00, 0x02,0x20, 0x00,0x00, 0x02,0x20, 0x00,0x00, 0x02,0x22, 0x22,0x22, 0x22};
Image portalClosed = Image(portalClosedData);
const PROGMEM uint8_t portalOpenedData[] = {8, 8, 2, 0, 2, 0xFF, 1, 0x00, 0x00,0x00, 0x00,0x00, 0x22,0x22, 0x00,0x02, 0x00,0x00, 0x20,0x02, 0x02,0x20, 0x20,0x02, 0x02,0x20, 0x20,0x02, 0x00,0x00, 0x20,0x00, 0x22,0x22, 0x00,0x00, 0x00,0x00, 0x00,0x02, 0x22,0x22, 0x20,0x20, 0x00,0x00, 0x02,0x20, 0x02,0x20, 0x02,0x20, 0x20,0x02, 0x02,0x20, 0x20,0x02, 0x02,0x20, 0x02,0x20, 0x02,0x20, 0x00,0x00, 0x02,0x02, 0x22,0x22, 0x20};
Image portalOpened = Image(portalOpenedData);
const PROGMEM uint8_t graveData[] = {8, 8, 1, 0, 0, 0x0E, 1, 0xee, 0xee,0xee, 0xee,0xee, 0x55,0x55, 0xee,0xe5, 0x66,0x66, 0x5e,0xe6, 0x60,0x06, 0x6e,0xe6, 0x00,0x00, 0x6e,0xe6, 0x60,0x06, 0x6e,0xe6, 0x60,0x06, 0x6e,0xe6, 0x66,0x66, 0x6e};
Image grave = Image(graveData);
const PROGMEM uint8_t crystalData[] = {8, 8, 1, 0, 0, 0x00, 1, 0x00, 0x00,0x20, 0x00,0x00, 0x07,0x20, 0xe2,0x2e, 0x07,0x22, 0x27,0xe2, 0x27,0x22, 0x72,0x27, 0x2e,0x27, 0x20,0x02, 0x7e,0xe2, 0x00,0x00, 0x27,0x20, 0x00,0x02, 0x2e,0x2e, 0x20};
Image crystal = Image(crystalData);
const PROGMEM uint8_t statueData[] = {8, 8, 1, 0, 0, 0x0E, 1, 0xe4, 0x44,0x44, 0x4e,0xe9, 0x99,0x99, 0x9e,0xee, 0x9a,0xa9, 0xee,0xee, 0x9a,0xa9, 0xee,0xee, 0x9a,0xa9, 0xee,0xee, 0x9a,0xa9, 0xee,0xe4, 0x9a,0xa9, 0x4e,0xe9, 0x99,0x99, 0x9e};
